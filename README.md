...
10. Update **io_config.yaml** file found here `2_mage/io_config.yaml`
...
11. Update **metada.yaml** file found here `2_mage/your_first_project/pipelines/cycles_data_pipeline/metadata.yaml`
...
12. Create a new or use an existing DBT cloud account - [dbt cloud](https://www.getdbt.com/)
